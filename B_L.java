...
public class B_L {
    ...
    public B_L(List<String> var1, List<float[]> var2, List<Float> var3, int var4, double[] var5, int var6) throws IOException {
        this.I = new HashMap();
        this.E = new HashMap();
        this.A = new HashMap();
        this.D = new HashMap();
        ...
        try{
            ...
            System.out.println("原来的getlist1_L.size()为"+getlist1_L.get(getlist1_L_size - 1));
            if (getlist1_L.get(getlist1_L_size - 1) != countline - 1) {
                getlist1_L.add(countline - 1);
                getlist2_L.add("add_L_value");
                getlist3_L.add(80.0);
            }
            System.out.println("判别后getlist1_L.size()为"+getlist1_L.size());
            ...
            System.out.println("最终轻链linesplitdou_L.size()为" + linesplitdou_L.size());
            System.out.println();
        ...
        for(int var7 = 0; var7 < var1.size(); ++var7) {
            ...
            List var10 = A(var8, var9, var4, var5, count, linesplitdou_L);  //跳转到第229行，k-mers集合
            int num = var10.size();
            count = num + count;
            //这里也和value有关
            outvalues.add(var10);
        ...
        //File outfile = new File("C:/Users/木子/Desktop/ALPS/test-file/value0222_L.csv");
        File outfile = new File("F:/研究生/ALPS/test-file/测试数据/Human_WIgG1-k5/HumanLH_spider/value0616_L.csv");
        ...
        writefile.close();
        System.out.println("写入value_L文件csv");
...
//            float var12 = (float)Math.exp((var9_d * getlinesplitdou * 0.01 + Math.log((double)var1[var5 + var2 - 1]) * var3[var2 - 1]) / (((double)var10 + var3[var2 - 1])* getlinesplitdou * 0.01));
            float var13 = (float)Math.exp((var9_d * getlinesplitdou * 0.01 + Math.log((double)var1[var5]) * var3[0]) / (((double)var10 + var3[0])));
            float var12 = (float)Math.exp((var9_d * getlinesplitdou * 0.01 + Math.log((double)var1[var5 + var2 - 1]) * var3[var2 - 1]) / (((double)var10 + var3[var2 - 1])));
