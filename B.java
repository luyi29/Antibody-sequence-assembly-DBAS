...
public class B {
    ...
    public B(List<String> var1, List<float[]> var2, List<Float> var3, int var4, double[] var5, int var6) throws IOException {
        this.I = new HashMap();
        this.E = new HashMap();
        this.A = new HashMap();
        this.D = new HashMap();
        ...
        try{
            ...
            String filename1 = "F:/研究生/ALPS/test-file/测试数据/Human_WIgG1_(3db)-220530/WIgG1_LightHeavy_our/de_novo/WIgG1_denovo_LH.csv_cut6.fasta";
            ...
            String filename2 = "F:/研究生/ALPS/test-file/测试数据/Human_WIgG1_(3db)-220530/WIgG1_LightHeavy_our/de_novo/abysis-IMGTgaps-mus_WIgG1_denovo_LH_cut6blast.txt";
            ...
            int getlist1_size = getlist1.size();
            System.out.println("比对得分最后一个seq序号为" + getlist1.get(getlist1_size-1));
            if(getlist1.get(getlist1_size-1) != countline - 1){
                getlist1.add(countline - 1);
                getlist2.add(80.0);
            }
            ...
            System.out.println("最终存储数据的数组长度为：" + linesplitdou.size());
            System.out.println();
        ...
        for(int var7 = 0; var7 < var1.size(); ++var7) {
            ...
            List var10 = A(var8, var9, var4, var5, count, linesplitdou);  //跳转到第229行，k-mers集合
            int num = var10.size();
            count = num + count;
            //这里也和value有关
            outvalues.add(var10);
        ...
        //File outfile = new File("C:/Users/木子/Desktop/ALPS/test-file/value0222_yz.csv");
        File outfile = new File("F:/研究生/ALPS/test-file/测试数据/Human_WIgG1_(3db)-220530/WIgG1_LightHeavy_our/de_novo/value0602_yz.csv");
        ...
        writefile.close();
        System.out.println("写入value_yz文件csv");
    ...
    public static List<C> A(String var0, float[] var1, int var2, double[] var3, int count, List<Double> linesplitdou) throws IOException {
        ...
        for(int var5 = 0; var5 < var0.length() - var2 + 1; ++var5) {
            ...
            for(int var11 = var5 + 1; var11 < var5 + var2 - 1; ++var11) {
                //原公式如下  var9 = (float)((double)var9 + Math.log((double)var1[var11]) * var3[var11 - var5]);
...
//            float var13 = (float)Math.exp((var9_d + Math.log((double)var1[var5]) * var3[0]) / ((double)var10 + var3[0]));
//            float var12 = (float)Math.exp((var9_d + Math.log((double)var1[var5 + var2 - 1]) * var3[var2 - 1]) / ((double)var10 + var3[var2 - 1]));
