...
public class k_mertofasta {
    ...
    public static ArrayList tok_mer(List<String> var0,  int var3) {
        D var10 = new D();
        ArrayList getkmer = var10.getK(var0, var3); //跳转D类第21行，构建德布鲁因图
        return getkmer;
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList result_out = tok_mer(var6, var2);

        int result_num = result_out.size();
        File f1 = new File(var1 + "_cut" + var2 + ".fasta");
        ...
        System.out.println("测试测试测试，写入成功，共有"+result_out.size());
        BW1.close();
    }
}
